...
def cost_elem_(y, y_hat):
    ...
    Args:
    y: has to be an np.ndarray, a vector.
    y_hat: has to be an np.ndarray, a vector.
    Returns:
    J_elem: np.ndarray, a vector of dimension (nb of the training examples,1).
    ...
    return (1 / (2 * y.size)) * pow((y_hat - y), 2)
